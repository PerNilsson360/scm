(
 ...
 ((assign val (op make-compiled-procedure) (label entry18) (reg env)) 
  ...
  (save continue) 
  (save env) 
  (assign proc (op lookup-variable-value) (const =) (reg env)) (assign val (const 1)) 
  ...
  (goto (reg val)) primitive-branch23 
  ...
  (assign proc (op lookup-variable-value) (const factorial) (reg env)) (save proc) 
  (assign proc (op lookup-variable-value) (const -) (reg env)) 
  ...
  (assign val (op apply-primitive-procedure) (reg proc) (reg argl)) 
  after-call28 
  (assign argl (op list) (reg val)) (test (op primitive-procedure?) (reg proc)) 
  ...
  after-call31 
  (assign argl (op cons) (reg val) (reg argl)) 
  (test (op primitive-procedure?) (reg proc)) (branch (label primitive-branch32)) 
  compiled-branch33 
  (assign val (op compiled-procedure-entry) (reg proc)) (goto (reg val)) 
  primitive-branch32 
...
((env) 
 ...
 ((save env) 
  ...
  (assign val (op compiled-procedure-entry) (reg proc)) 
  (goto (reg val)) primitive-branch41 
  (assign val (op apply-primitive-procedure) (reg proc) (reg argl)) 
  after-call43 
  (perform (op set-variable-value!) (const foo) (reg val) (reg env)) 
  (assign val (const ok))))